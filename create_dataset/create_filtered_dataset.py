...
def filter_faces(paths, removed=[], image_size=160):    
    imgs = []
    ...
    for filepath in paths:
        ...
        imgsharp = cv2.filter2D(im_new, -1, kernel)
...
removed_testing = []
cropped_testing, cropped_paths_testing = filter_faces(testing_paths, removed_testing)
...
removed_training = []
cropped_training, cropped_paths_training = filter_faces(training_paths, removed_training)
